...
def deskew_stack(stack, scan_range = 6.0, pxl = 0.103, method = 'fourier', crop = True):
    '''
    ...
    DXB = np.linspace(0., scan_range, NZ)-scan_range/2. # The scan range
    ...
    if crop:
        padded_stack = padded_stack[:,n_pad:n_pad+NY, :]
    return padded_stack
