...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox_PSF = QtWidgets.QGroupBox(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.groupBox_PSF.sizePolicy().hasHeightForWidth())
        self.groupBox_PSF.setSizePolicy(sizePolicy)
        self.groupBox_PSF.setMaximumSize(QtCore.QSize(150, 16777215))
        self.groupBox_PSF.setObjectName("groupBox_PSF")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.groupBox_PSF)
        self.gridLayout_4.setObjectName("gridLayout_4")
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_4.addItem(spacerItem, 16, 0, 1, 1)
        self.checkBoxCenterLateral = QtWidgets.QCheckBox(self.groupBox_PSF)
        ...
        self.label_nSlice = QtWidgets.QLabel(self.groupBox_PSF)
        self.label_nSlice.setObjectName("label_nSlice")
        self.gridLayout_4.addWidget(self.label_nSlice, 2, 0, 1, 1)
        self.label_nFrame = QtWidgets.QLabel(self.groupBox_PSF)
        self.label_nFrame.setObjectName("label_nFrame")
        self.gridLayout_4.addWidget(self.label_nFrame, 3, 0, 1, 1)
        self.pushButton_loadconfig = QtWidgets.QPushButton(self.groupBox_PSF)
        ...
        self.label_CY = QtWidgets.QLabel(self.groupBox_PSF)
        self.label_CY.setObjectName("label_CY")
        self.gridLayout_4.addWidget(self.label_CY, 6, 0, 1, 1)
        self.label_range = QtWidgets.QLabel(self.groupBox_PSF)
        self.label_range.setObjectName("label_range")
        self.gridLayout_4.addWidget(self.label_range, 1, 0, 1, 1)
        self.label_fname = QtWidgets.QLabel(self.groupBox_PSF)
        ...
        self.pushButton_saveconfig = QtWidgets.QPushButton(self.groupBox_PSF)
        ...
        self.label_mask = QtWidgets.QLabel(self.groupBox_PSF)
        self.label_mask.setObjectName("label_mask")
        self.gridLayout_4.addWidget(self.label_mask, 4, 0, 1, 1)
        self.doubleSpinBoxRange = QtWidgets.QDoubleSpinBox(self.groupBox_PSF)
        ...
        self.spinBox_maskRadius = QtWidgets.QSpinBox(self.groupBox_PSF)
        ...
        self.pushButton_Acquire = QtWidgets.QPushButton(self.groupBox_PSF)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lineEdit_cX = QtWidgets.QLineEdit(self.groupBox_PSF)
        ...
        self.label_CX = QtWidgets.QLabel(self.groupBox_PSF)
        self.label_CX.setObjectName("label_CX")
        self.gridLayout_4.addWidget(self.label_CX, 5, 0, 1, 1)
        self.lineEdit_imagedest = QtWidgets.QLineEdit(self.groupBox_PSF)
        ...
        self.lineEdit_cY = QtWidgets.QLineEdit(self.groupBox_PSF)
        ...
        self.spinBoxSlices = QtWidgets.QSpinBox(self.groupBox_PSF)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.spinBoxFrames = QtWidgets.QSpinBox(self.groupBox_PSF)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_confpath = QtWidgets.QLabel(self.groupBox_PSF)
        self.label_confpath.setObjectName("label_confpath")
        self.gridLayout_4.addWidget(self.label_confpath, 11, 0, 1, 2)
        self.checkBox_deskew = QtWidgets.QCheckBox(self.groupBox_PSF)
        self.checkBox_deskew.setObjectName("checkBox_deskew")
        self.gridLayout_4.addWidget(self.checkBox_deskew, 8, 0, 1, 1)
        self.lineEdit_config = QtWidgets.QLineEdit(self.groupBox_PSF)
        self.lineEdit_config.setObjectName("lineEdit_config")
        self.gridLayout_4.addWidget(self.lineEdit_config, 12, 0, 1, 2)
        self.horizontalLayout.addWidget(self.groupBox_PSF)
        ...
        self.pushButton_addmod = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_addmod.sizePolicy().hasHeightForWidth())
        self.pushButton_addmod.setSizePolicy(sizePolicy)
        self.pushButton_addmod.setObjectName("pushButton_addmod")
        self.horizontalLayout_2.addWidget(self.pushButton_addmod)
        ...
        self.pushButton_delmod = QtWidgets.QPushButton(self.groupBoxModulations)
        self.pushButton_delmod.setObjectName("pushButton_delmod")
        self.verticalLayoutModulations.addWidget(self.pushButton_delmod)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_PSF.setTitle(_translate("Form", "PSF"))
        self.checkBoxCenterLateral.setText(_translate("Form", "Center PSF laterally"))
        self.label_nSlice.setText(_translate("Form", "# Slices:"))
        self.label_nFrame.setText(_translate("Form", "# Frames/slice:"))
        self.pushButton_loadconfig.setText(_translate("Form", "Load configuration"))
        self.label_CY.setText(_translate("Form", "Center Y:"))
        self.label_range.setText(_translate("Form", "Range [um]:"))
        ...
        self.label_confpath.setText(_translate("Form", "Configuration path"))
        ...
        self.pushButton_addmod.setText(_translate("Form", "add to mod list"))
